...
define Device/mt7981-spim-nand-7981r128-g
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7981-spim-nand-7981r128-g
  DEVICE_DTS := mt7981-spim-nand-7981r128-g
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  DEVICE_PACKAGES := $(MT7981_USB_PKGS)
  SUPPORTED_DEVICES := mediatek,mt7981-spim-snand-7981r128-g
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 117248k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mt7981-spim-nand-7981r128-g

define Device/mt7981-spim-nand-7981r128-wan-p5-g
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7981-spim-nand-7981r128-wan-p5-g
  DEVICE_DTS := mt7981-spim-nand-7981r128-wan-p5-g
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  DEVICE_PACKAGES := $(MT7981_USB_PKGS)
  SUPPORTED_DEVICES := mediatek,mt7981-spim-snand-7981r128-wan-p5-g
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 117248k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mt7981-spim-nand-7981r128-wan-p5-g
