...
define Device/mt7981-spim-nand-7981r128-gsw
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7981-spim-nand-7981r128-gsw
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mt7981-spim-nand-7981r128-gsw

define Device/mt7981-spim-nand-7981r128-wan-p5-gsw
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7981-spim-nand-7981r128-wan-p5-gsw
  DEVICE_DTS := mt7981-spim-nand-7981r128-wan-p5-gsw
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  DEVICE_PACKAGES := $(MT7981_USB_PKGS)
  SUPPORTED_DEVICES := mediatek,mt7981-spim-snand-7981r128
  UBINIZE_OPTS := -E 5
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mt7981-spim-nand-7981r128-wan-p5-gsw
