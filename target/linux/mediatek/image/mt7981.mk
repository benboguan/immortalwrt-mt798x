...
define Device/mt7981-spim-nand-7981r128-dsa
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7981-spim-nand-7981r128-dsa
  DEVICE_DTS := mt7981-spim-nand-7981r128-dsa
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  DEVICE_PACKAGES := $(MT7981_USB_PKGS)
  SUPPORTED_DEVICES := mediatek,mt7981-spim-snand-7981r128-dsa
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 117248k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mt7981-spim-nand-7981r128-dsa
...
define Device/mt7981-360-t7
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := 360 T7
  DEVICE_ALT0_VENDOR := MediaTek
  DEVICE_ALT0_MODEL := 360 T7m
